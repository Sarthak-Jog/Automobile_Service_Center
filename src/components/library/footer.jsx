        ...
        <Row>
          ...
          <Col md="4">
            ...
            <ul className="list-unstyled">
              ...
              <li><a href="/cars" className="text-white text-decoration-none">Cars</a></li>
              <li><a href="/blogs" className="text-white text-decoration-none">Blog</a></li>
          ...
          <Col md="4">
            <h5>Contact Info</h5>
            <p>
              <i className="ri-map-pin-line"></i> SAMBHAJI NAGAR
            </p>
            <p>
